...
########## Evaluate NEW DeViSE (unknown labels)##########
...
print("########## Start evaluating simpleCNN newdevice ##########")
sess = tf.Session()
...
y1 = tf.get_default_graph().get_tensor_by_name("y1:0")
y2 = tf.get_default_graph().get_tensor_by_name("y2:0")
...
print("Evaluate simpleCNN newdevise")
...
# Evaluate the model and print results
# What model to be evaluated?
STORED_PATH = "./saved_model/cifar100_AlexNet_newdevise/devise.ckpt"
...
print("########## Start evaluating AlexNet newdevice ##########")
sess = tf.Session()
# restore the precious best model
saver = tf.train.import_meta_graph(STORED_PATH + ".meta")
print('operations:',tf.get_default_graph().get_operations())
...
print("Evaluate AlexNet newdevise")
print("Test result: Top 1 hit rate", top1_hit/100, "%")
print("Test result: Top 3 hit rate", top3_hit/100, "%")
print("Test result: Top 5 hit rate", top5_hit/100, "%")
...
print("########## Start evaluating VGG newdevice ##########")
sess = tf.Session()
# restore the precious best model
saver = tf.train.import_meta_graph(STORED_PATH + ".meta")
print('operations:',tf.get_default_graph().get_operations())
