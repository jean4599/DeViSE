...
def cnn_model(features, labels, train_mode):
    ...
    # VGGNet
    # conv1
    conv1 = Conv2d_BN('conv1', input_layer, 3, 3, 64, 1, 'SAME', tf.nn.relu)
    print("conv1 tensor: ", conv1)
    # conv2
    conv2 = Conv2d_BN('conv2', conv1, 3, 64, 64, 1, 'SAME', tf.nn.relu)
    ...
    # conv3
    conv3 = Conv2d_BN('conv3', pool1, 3, 64, 128, 1, 'SAME', tf.nn.relu)
    print("conv3 tensor: ", conv3)
    # conv4
    conv4 = Conv2d_BN('conv4', conv3, 3, 128, 128, 1, 'SAME', tf.nn.relu)
    ...
    # conv5
    conv5 = Conv2d_BN('conv5', pool2, 3, 128, 256, 1, 'SAME', tf.nn.relu)
    print("conv5 tensor: ", conv5)
    # conv6
    conv6 = Conv2d_BN('conv6', conv5, 3, 256, 256, 1, 'SAME', tf.nn.relu)
    print("conv6 tensor: ", conv6)
    # conv7
    conv7 = Conv2d_BN('conv7', conv6, 3, 256, 256, 1, 'SAME', tf.nn.relu)
    print("conv7 tensor: ", conv7)
    # pool3
    pool3 = tf.nn.max_pool(conv7, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME', name='pool3')
    print("pool3 tensor: ", pool3)

    # conv8
    conv8 = Conv2d_BN('conv8', pool3, 3, 256, 512, 1, 'SAME', tf.nn.relu)
    print("conv8 tensor: ", conv8)
    # conv9
    conv9 = Conv2d_BN('conv9', conv8, 3, 512, 512, 1, 'SAME', tf.nn.relu)
    print("conv9 tensor: ", conv9)
    # conv10
    conv10 = Conv2d_BN('conv10', conv9, 3, 512, 512, 1, 'SAME', tf.nn.relu)
    print("conv10 tensor: ", conv10)
    # pool4
    pool4 = tf.nn.max_pool(conv10, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME', name='pool4')
    print("pool4 tensor: ", pool4)

    # conv11
    conv11 = Conv2d_BN('conv11', pool4, 3, 512, 512, 1, 'SAME', tf.nn.relu)
    print("conv11 tensor: ", conv11)
    # conv12
    conv12 = Conv2d_BN('conv12', conv11, 3, 512, 512, 1, 'SAME', tf.nn.relu)
    print("conv12 tensor: ", conv12)
    # conv13
    conv13 = Conv2d_BN('conv13', conv12, 3, 512, 512, 1, 'SAME', tf.nn.relu)
    print("conv13 tensor: ", conv13)
    # pool5
    pool5 = tf.nn.max_pool(conv13, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME', name='pool5')
    print("pool5 tensor: ", pool5)
